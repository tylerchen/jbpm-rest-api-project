...
public class VariablesDefinitionVO implements Serializable {

	@XStreamConverter(StringStringMapConverter.class)
	@XStreamAlias("variables")
	private Map<String, String> variables = new HashMap<String, String>();

	public VariablesDefinitionVO() {
	}

	public VariablesDefinitionVO(Map<String, String> variables) {
	...
	public String toString() {
		return "VariablesDefinition{" + "variables=" + variables + '}';
	}
}
